...
if __name__=="__main__":
    dataset_train = SoccerNet(frames_per_clip=41, split="train", frames_path="/nas/softechict-nas-2/mtomei/datasets/SoccerNet/Frames_HQ", labels_path="/nas/softechict-nas-2/mtomei/datasets/SoccerNet/annotations_v2", listgame_path="/nas/softechict-nas-2/mtomei/datasets/SoccerNet/Labels")
    dataset_val = SoccerNet(frames_per_clip=41, split="val", frames_path="/nas/softechict-nas-2/mtomei/datasets/SoccerNet/Frames_HQ", labels_path="/nas/softechict-nas-2/mtomei/datasets/SoccerNet/annotations_v2", listgame_path="/nas/softechict-nas-2/mtomei/datasets/SoccerNet/Labels")
    dataset_train[0]
    print("Done!")